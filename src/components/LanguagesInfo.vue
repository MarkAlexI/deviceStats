<template>
  <div class="block__item">
    <div class="block__item__wrap">
      <h3 class="block__title">Languages used by the browser:</h3>
      <div v-for="(language, index) in browserLanguages" class="block__list">
        <p :key="index" class="block__content">{{ language }}</p>
      </div>
    </div>
  </div>
</template>
...
<style>
  ...
  .block__item__wrap:hover .block__title {
    color: gold;
  }
